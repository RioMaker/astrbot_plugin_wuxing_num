...
- 每宫将徽记与数字并排显示，下方写明五行和象意；根气宫另有描边与“根”字。
...
徽记图集保存在 `assets/icons/wuxing_emblems.png`，随插件发布；不依赖临时附件路径或外网。缺少或损坏时回退到原五行纹样，并在图上注明标志暂不可用。来源、图集布局和生成提示词见 [素材说明](assets/icons/README.md)。
